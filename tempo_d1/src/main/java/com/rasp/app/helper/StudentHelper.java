 ...
 */
 public class StudentHelper extends BaseHelper {
		public StudentHelper() {super(new Student());}
		private static StudentHelper instance;
		public static StudentHelper getInstance() {if (instance == null)	{instance = new StudentHelper();register_birecord();} return instance;}
