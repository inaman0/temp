 ...
 */
@Component
 public class RoleResourcePermission extends BaseResource {
	...
	public static String FIELD_RESOURCE = "resource";
	public static String FIELD_ACTION = "action";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("role_resource_permission");
	...
	static {
		...
		roleField.setLength(40);
		metaData.addField(roleField);

		Field resourceField = new Field("resource", "String");
		resourceField.setIndexed(true);
		resourceField.setRequired(true);
		resourceField.setLength(128);
		metaData.addField(resourceField);

		Field actionField = new Field("action", "Array");
		actionField.setIndexed(true);
		actionField.setLength(128);
		actionField.setValueType("String");
		metaData.addField(actionField);
		...
		metaData.setTableName("role_resource_permission");

		metaData.setCluster("DB_ACCOUNT");
	}

	public RoleResourcePermission() {this.setId(Util.getUniqueId());}
	public RoleResourcePermission(String id) {this.setId(id);}

	public RoleResourcePermission(RoleResourcePermission obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		action = (List<String>) map.get("action");
	...
	public boolean validateResource(boolean add) throws ApplicationException {
		if(add && resource == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[resource]");
	...
	public  Class<?> getResultClass() {return RoleResourcePermissionResult.class;};
	public  Class<?> getMessageClass() {return RoleResourcePermissionMessage.class;};
	public  Class<?> getHelperClass() {return RoleResourcePermissionHelper.class;};
	public  Class<?> getServiceClass() {return RoleResourcePermissionService.class;};
}