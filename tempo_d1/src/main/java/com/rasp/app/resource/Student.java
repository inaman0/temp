...
@Component
 public class Student extends BaseResource {
	...
	public static String FIELD_S_NAME = "s_name";
	public static String FIELD_STATUS = "status";
	public static String FIELD_B_ID = "b_id";
	...
	static {
		...
		Field s_nameField = new Field("s_name", "String");
		s_nameField.setRequired(true);
		metaData.addField(s_nameField);

		Field statusField = new Field("status", "String");
		statusField.setRequired(true);
		metaData.addField(statusField);

		Field b_idField = new Field("b_id", "String");
		b_idField.setRequired(true);
		b_idField.setForeign(new Foreign("Batch"));
		metaData.addField(b_idField);
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		s_name = (String) map.get("s_name");
		status = (String) map.get("status");
		b_id = (String) map.get("b_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object s_nameObj = map.get("s_name");
		if(s_nameObj != null)
			s_name = s_nameObj.toString();

		Object statusObj = map.get("status");
		if(statusObj != null)
			status = statusObj.toString();

		Object b_idObj = map.get("b_id");
		if(b_idObj != null)
			b_id = b_idObj.toString();
	...
	public boolean validateS_name(boolean add) throws ApplicationException {
		if(add && s_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[s_name]");
		return s_name != null;
	}
	...
	public String getB_idEx() {
		return b_id != null ? b_id : "";
	}
	...
	public boolean validateB_id(boolean add) throws ApplicationException {
		if(add && b_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[b_id]");
		return b_id != null;
	}
