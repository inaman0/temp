...
import com.rasp.app.helper.ResRoleTypeHelper;
import com.rasp.app.message.ResRoleTypeMessage;
 ...
 */
@Component
 public class ResRoleType extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("res_role_type");
	...
	static {
		...
		resource_nameField.setRequired(true);
		...
		metaData.setTableName("res_role_type");

		metaData.setCluster("DB_ACCOUNT");
	}

	public ResRoleType() {this.setId(Util.getUniqueId());}
	public ResRoleType(String id) {this.setId(id);}

	public ResRoleType(ResRoleType obj) {
		this.id = obj.id;
	...
	public boolean validateResource_name(boolean add) throws ApplicationException {
		if(add && resource_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[resource_name]");
	...
	public  Class<?> getResultClass() {return ResRoleTypeResult.class;};
	public  Class<?> getMessageClass() {return ResRoleTypeMessage.class;};
	public  Class<?> getHelperClass() {return ResRoleTypeHelper.class;};
	public  Class<?> getServiceClass() {return ResRoleTypeService.class;};
}