 ...
 */
@Component
 public class Traveler extends BaseResource {
	...
	private String traveler_name = null;
	private String traveler_email = null;
	...
	public static String FIELD_TRAVELER_NAME = "traveler_name";
	public static String FIELD_TRAVELER_EMAIL = "traveler_email";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("traveler");
	...
	static {
		...
		Field traveler_nameField = new Field("traveler_name", "String");
		traveler_nameField.setRequired(true);
		metaData.addField(traveler_nameField);

		Field traveler_emailField = new Field("traveler_email", "String");
		traveler_emailField.setRequired(true);
		metaData.addField(traveler_emailField);
		...
		metaData.setTableName("traveler");

		metaData.setCluster("traveler_db");
	}

	public Traveler() {this.setId(Util.getUniqueId());}
	public Traveler(String id) {this.setId(id);}

	public Traveler(Traveler obj) {
		this.id = obj.id;
		...
		this.traveler_name = obj.traveler_name;
		this.traveler_email = obj.traveler_email;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(traveler_name != null)
			map.put("traveler_name", traveler_name);
		if(traveler_email != null)
			map.put("traveler_email", traveler_email);
		if(extra_data != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateTraveler_name(add))
			map.put("traveler_name", traveler_name);
		if(validateTraveler_email(add))
			map.put("traveler_email", traveler_email);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		traveler_name = (String) map.get("traveler_name");
		traveler_email = (String) map.get("traveler_email");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object traveler_nameObj = map.get("traveler_name");
		if(traveler_nameObj != null)
			traveler_name = traveler_nameObj.toString();

		Object traveler_emailObj = map.get("traveler_email");
		if(traveler_emailObj != null)
			traveler_email = traveler_emailObj.toString();
	...
	public String getTraveler_nameEx() {
		return traveler_name != null ? traveler_name : "";
	}
	...
	public void unSetTraveler_name() {
		this.traveler_name = null;
	}

	public boolean validateTraveler_name(boolean add) throws ApplicationException {
		if(add && traveler_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[traveler_name]");
		return traveler_name != null;
	}
	...
	public String getTraveler_emailEx() {
		return traveler_email != null ? traveler_email : "";
	}
	...
	public void unSetTraveler_email() {
		this.traveler_email = null;
	}

	public boolean validateTraveler_email(boolean add) throws ApplicationException {
		if(add && traveler_email == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[traveler_email]");
		return traveler_email != null;
	}
	...
	public  Class<?> getResultClass() {return TravelerResult.class;};
	public  Class<?> getMessageClass() {return TravelerMessage.class;};
	public  Class<?> getHelperClass() {return TravelerHelper.class;};
	public  Class<?> getServiceClass() {return TravelerService.class;};
}