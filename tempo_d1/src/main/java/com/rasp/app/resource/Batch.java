 ...
 */
@Component
 public class Batch extends BaseResource {
	...
	public static String FIELD_BATCH_CODE = "batch_code";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("batch");
	...
	static {
		...
		batch_nameField.setRequired(true);
		metaData.addField(batch_nameField);

		Field batch_codeField = new Field("batch_code", "String");
		batch_codeField.setRequired(true);
		metaData.addField(batch_codeField);
		...
		metaData.setTableName("batch");

		metaData.setCluster("exam_portal");
	}

	public Batch() {this.setId(Util.getUniqueId());}
	public Batch(String id) {this.setId(id);}

	public Batch(Batch obj) {
		this.id = obj.id;
		...
		this.batch_code = obj.batch_code;
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateBatch_name(add))
			map.put("batch_name", batch_name);
		if(validateBatch_code(add))
			map.put("batch_code", batch_code);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		batch_code = (String) map.get("batch_code");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object batch_codeObj = map.get("batch_code");
		if(batch_codeObj != null)
			batch_code = batch_codeObj.toString();
	...
	public boolean validateBatch_name(boolean add) throws ApplicationException {
		if(add && batch_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[batch_name]");
		return batch_name != null;
	}
	...
	public String getBatch_codeEx() {
		return batch_code != null ? batch_code : "";
	}
	...
	public void unSetBatch_code() {
		this.batch_code = null;
	}

	public boolean validateBatch_code(boolean add) throws ApplicationException {
		if(add && batch_code == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[batch_code]");
		return batch_code != null;
	}
	...
	public  Class<?> getResultClass() {return BatchResult.class;};
	public  Class<?> getMessageClass() {return BatchMessage.class;};
	public  Class<?> getHelperClass() {return BatchHelper.class;};
	public  Class<?> getServiceClass() {return BatchService.class;};
}