 ...
 */
@Component
 public class ResourceRole extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("resource_role");
	...
	static {
		...
		metaData.setTableName("resource_role");

		metaData.setCluster("DB_ACCOUNT");
	}

	public ResourceRole() {this.setId(Util.getUniqueId());}
	public ResourceRole(String id) {this.setId(id);}

	public ResourceRole(ResourceRole obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return ResourceRoleResult.class;};
	public  Class<?> getMessageClass() {return ResourceRoleMessage.class;};
	public  Class<?> getHelperClass() {return ResourceRoleHelper.class;};
	public  Class<?> getServiceClass() {return ResourceRoleService.class;};
}