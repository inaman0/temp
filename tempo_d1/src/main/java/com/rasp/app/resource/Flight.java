...
@Component
 public class Flight extends BaseResource {
	...
	public static String FIELD_FLIGHT_NAME = "flight_name";
	...
	static {
		...
		Field flight_nameField = new Field("flight_name", "String");
		flight_nameField.setRequired(true);
		metaData.addField(flight_nameField);

		Field airline_idField = new Field("airline_id", "String");
		airline_idField.setRequired(true);
	...
	public Flight(Flight obj) {
		...
		this.flight_name = obj.flight_name;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(flight_name != null)
			map.put("flight_name", flight_name);
		if(airline_id != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateFlight_name(add))
			map.put("flight_name", flight_name);
		if(validateAirline_id(add))
			map.put("airline_id", airline_id);
		if(location_id != null)
			map.put("location_id", location_id);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		flight_name = (String) map.get("flight_name");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object flight_nameObj = map.get("flight_name");
		if(flight_nameObj != null)
			flight_name = flight_nameObj.toString();
	...
	public String getFlight_nameEx() {
		return flight_name != null ? flight_name : "";
	}
	...
	public void unSetFlight_name() {
		this.flight_name = null;
	}

	public boolean validateFlight_name(boolean add) throws ApplicationException {
		if(add && flight_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[flight_name]");
		return flight_name != null;
	}
	...
	public boolean validateAirline_id(boolean add) throws ApplicationException {
		if(add && airline_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[airline_id]");
		return airline_id != null;
	}
